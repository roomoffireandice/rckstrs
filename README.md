...
```
     1) In the Springboot Java Application, I have used the same container name "mysqlsvc" in the application.properties file.

          ```
          spring.datasource.url=jdbc:mysql://mysqlsvc:3306/test
